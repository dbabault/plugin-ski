    ...
    <div id="lend_content">
        <form id="filtre" method="POST" action="{path_for name=ski_filter_form data=[type=>list]}" method="POST" id="filtre">
            <div id="listfilter">
                ...
                <input type="text" name="filter_str" id="filter_str" value="{$filters->filter_str}" type="search" placeholder="{_T string='Enter a value' domain='ski'}" />&nbsp;
        ...
        <form action="{'ski_form_list'}" method="post" id="form_list">
            <table class="listing">
                <thead>
                    <tr>
                        <th>
                        ...
                        <th>
                            <a href="{path_for name='ski_form_list' data=['option'=>'order','value'=>'GaletteSki\Repository\Form::ORDERBY_BDATE'|constant]}">
                        ...
                        <th>
                            <a href="{path_for name='ski_form_list' data=['option'=>'order','value'=>'GaletteSki\Repository\Form::ORDERBY_FDATE'|constant]}">
                        ...
                        <th>
                            <a href="{path_for name=ski_form_list data=['option'=>'order','value' =>'GaletteSki\Repository\Form::ORDERBY_EDATE'|constant]}">
                ...
                <tbody>
                    ...
                    <td class="center nowrap">
                        ...
                        <a class="tooltip action" href="{path_for name='ski_form'}/{$form_id}" title="{_T string='Open the form' domain='ski' }">
                            <i class="fas fa-edit">
                            </i>
                            <span class="sr-only">{_T string='Edit the form' domain='ski'}
                            </span>
                        </a>
                        <a class="tooltip" href="{path_for name='ski_form_printform'}/{$form_id}" title="{_T string='form card in PDF' domain='ski' }">
                        ...
                        {/if}
                        {if $login->isAdmin()}
                        <a class="delete tooltip" href="{path_for name='ski_remove_form'}/{$form_id}" title="{_T string='Remove from database' domain="ski"}">
                            <i class="fas fa-trash">
                            </i>
                            <span class="sr-only">{_T string='Remove from database' domain="ski" }
                            </span>
                        </a>
                        {/if}
                    </td>
                ...
                <tr>
                    <td colspan="14" class="emptylist">{_T string='No form has been found' domain='ski'}
                    </td>
                </tr>
                {/foreach}
            </tbody>
